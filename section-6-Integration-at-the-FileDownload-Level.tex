...
If these conditions are met, the request\_circuit event is triggered. \textbf{(TW: since we're talking about an event-driven framework it's worth mentioning which events trigger which!)}
