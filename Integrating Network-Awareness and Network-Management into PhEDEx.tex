...
This includes the integration of a new transfer backend using
the Fast Data Transfer (FDT) tool and the creation of a prototype site
agent which allows PhEDEx to control the network via dynamic circuits. We
...
\input{section-2-ANSE-setup.tex}
\input{section-3-Integrating-external-sources-of-information.tex}
\input{section-4-Integrating-virtual-circuts-into-PhEDEx.tex}
\input{section-5-Integration-at-the-transfer-level.tex}
\input{section-6-Integration-at-the-FileDownload-Level.tex}
