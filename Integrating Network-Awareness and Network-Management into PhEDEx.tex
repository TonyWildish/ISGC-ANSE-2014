...
%TODO% 
%- Create a new section for ANSE setup (move everything from the ''Integration at the FileDownload Level''section 
...
\input{section-Integrating-external-sources-of-information.tex}
\input{section-Integration-at-the-transfer-level.tex}
